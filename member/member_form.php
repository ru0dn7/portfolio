	...
	<script>
        ...
        function check_input()
        {
                ...
                document.member_form.pass_confirm.value)
            {
                ...
                document.member_form.pass.focus();
                document.member_form.pass.select(); // 해당 위치에 블럭주기
                return;
            }
...
<body>
    ...
    <header>
        <h1><a href="../index.html">커핀그루나루 로고</a></h1>
    </header>
    ...
    <article id="content">
        ...
        <div class="joinform_wrap">
            <form  name="member_form" method="post" action="insert.php">
                ...
                <dl>
                    <dt class="req"><label for="id">아이디</label></dt>
                    <dd>
                ...
                <dl>
                    <dt class="req"><label for="pass">비밀번호</label></dt>
                    <dd>
                        <input type="password" name="pass" id="pass" placeholder="비밀번호를 입력하세요." required>
                    </dd>
                </dl>
                <dl>
                    <dt class="req"><label for="pass_confirm">비밀번호 확인</label></dt>
                    <dd>
                ...
                <dl>
                    <dt class="req"><label for="name">이름</label></dt>
                    <dd>
                        <input type="text" name="name" id="name" placeholder="이름을 입력하세요" required>
                    </dd>
                </dl>
                <dl>
                    <dt class="req"><label for="nick">닉네임</label></dt>
                    <dd>
