            ...
            <form  name="find" method="post" action="find2.php">
                ...
                <ul>
                    <li>
                        ...
                        <input title="name" type="text" name="name" class="find_name" placeholder="이름을 입력하세요" required />
                    </li>
                    <li>
                        <label class="hidden" for="id">아이디</label>
                        <input title="id" type="text" name="id" class="find_id" placeholder="아이디를 입력하세요" required />
                    </li>
                    <li class="hp">
